...
public partial class BhotldrenBattleScene : FullScreenBossBase
{
    ...
    public override async void _Ready()
    {
        ...
        openingShotPlayer.Play("bhotldren_opening_shot");

        _dialogBox = GetNode<AscendedTextbox>("%AscendedTextbox");
        _dialogBox.SetName(EnemyNames.Bhotldren);
        _dialogBox.SetBlips("res://screens/cutscene/boss_male.wav");

        InternalReady();

        InitializeBattleScene(EnemyNames.Bhotldren, true, false);
