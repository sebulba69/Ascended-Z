...
public partial class Lab151 : CutsceneBase
{
    ...
    public async override void _Ready()
    {
        ...
        [
            ...
            "The spell that calls the Ascended game...\nIt is unlike any your world has ever\nseen.",
            "Its origins are unknown, and its creators unknowable.",
            "All that can be said is that it was devised\nby higher beings who want nothing more than\nraw demonstrations of strength.",
            "This was something the legend of\nyour world wish to end. So, he\nmade an attempt at Ascension.",
            "At the same time, his rival too attempted\nto conquer the game at the same time...",
            "Meanwhile, in the absence of the hero,\nlegends would spread of his deeds.",
            "They would become twisted, distorted...",
            "Such that, after many years, he was\ndeclared a martyr who not only conquered\nthe game...",
            "...but also defeated his rivals who,\nunbeknownst to them, were his competitors!",
            "How could these legends be lies?\nWhat became of this hero?",
            "The only way to find out is to continue\nyour quest and Ascend!"
        ];
